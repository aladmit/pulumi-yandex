...
class GetDataprocClusterResult:
    ...
    """
    def __init__(__self__, bucket=None, cluster_config=None, cluster_id=None, created_at=None, description=None, folder_id=None, id=None, labels=None, name=None, service_account_id=None, ui_proxy=None, zone_id=None):
