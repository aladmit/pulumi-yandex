...
class GetMdbKafkaClusterResult:
    ...
    """
    def __init__(__self__, cluster_id=None, config=None, created_at=None, description=None, environment=None, folder_id=None, health=None, id=None, labels=None, name=None, network_id=None, security_group_ids=None, status=None, subnet_ids=None, topics=None, users=None):
